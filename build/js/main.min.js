...
/* harmony import */ var _modules_footer_accordion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/footer-accordion */ "./js/modules/footer-accordion.js");
...
/* harmony import */ var _modules_inputmask__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/inputmask */ "./js/modules/inputmask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_header__WEBPACK_IMPORTED_MODULE_2__["initStickyHeader"])();
  Object(_modules_footer_accordion__WEBPACK_IMPORTED_MODULE_3__["initAccordion"])();
  Object(_modules_show_more__WEBPACK_IMPORTED_MODULE_4__["initDisplayText"])();
  Object(_modules_inputmask__WEBPACK_IMPORTED_MODULE_5__["initInputPhoneMask"])();
...
var accordionElements = document.querySelectorAll('[data-spoiler]');
var accordionToggles = document.querySelectorAll('[data-spoiler-toggle]');
var MEDIA_MOBILE_BREAKPOINT = '(max-width: 767px)';
var breakpoint = window.matchMedia(MEDIA_MOBILE_BREAKPOINT);
var initAccordion = function initAccordion() {
  if (accordionElements) {
    if (breakpoint.matches) {
      accordionElements.forEach(function (e) {
        e.classList.add('is-closed');
      });
      accordionToggles.forEach(function (e) {
...
function accordionToggleClickHandler(evt) {
  var accordionToggle = evt.target;
...
/*!******************************!*\
  !*** ./js/modules/header.js ***!
  \******************************/
/*! exports provided: initStickyHeader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initStickyHeader", function() { return initStickyHeader; });
var headerContainerElement = document.querySelector('[data-page-header]');
var headerElement = headerContainerElement.querySelector('.page-header__wrap');
var MEDIA_DESKTOP_BREAKPOINT = '(max-width: 1023px)';
var breakpoint = window.matchMedia(MEDIA_DESKTOP_BREAKPOINT);
var scrollPos = 1;
...
/*!*********************************!*\
  !*** ./js/modules/inputmask.js ***!
  \*********************************/
/*! exports provided: initInputPhoneMask */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initInputPhoneMask", function() { return initInputPhoneMask; });
var inputPhoneElements = document.querySelectorAll('[data-input-tel]');
var initInputPhoneMask = function initInputPhoneMask() {
  if (inputPhoneElements) {
    inputPhoneElements.forEach(function (inputPhoneElement) {
      inputPhoneElement.onfocus = function () {
        if (inputPhoneElement.value.length === 0) {
          inputPhoneElement.value = '+7(';
          mask.updateValue();
        }
      };
      inputPhoneElement.onblur = function () {
        if (inputPhoneElement.value.length <= 3) {
          inputPhoneElement.value = '';
        }
      };
      var mask = new IMask(inputPhoneElement, {
      ...
      inputPhoneElement.addEventListener('input', function () {
        if (inputPhoneElement.validity.valueMissing) {
          inputPhoneElement.setCustomValidity('Укажите номер телефона');
        } else if (inputPhoneElement.value.length < 16 && inputPhoneElement.value.length > 3) {
          inputPhoneElement.setCustomValidity('Номер слишком короткий');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initDisplayText", function() { return initDisplayText; });
var aboutContainerElement = document.querySelector('[data-about]');
var textElements = aboutContainerElement.querySelectorAll('p');
var buttonElement = aboutContainerElement.querySelector('button');
var textElementMobile = aboutContainerElement.querySelector('span');
var DISPLAY_PARAGRAPHS_COUNT = 2;
var BUTTON_TEXT_DISPLAY = 'Свернуть';
var BUTTON_TEXT_HIDE = 'Подробнее';
var initDisplayText = function initDisplayText() {
  if (aboutContainerElement && textElements.length > 1) {
    for (var i = DISPLAY_PARAGRAPHS_COUNT; i < textElements.length; i++) {
    ...
    buttonElement.addEventListener('click', function () {
      if (aboutContainerElement.classList.contains('is-hide')) {
        ...
        for (var _i = DISPLAY_PARAGRAPHS_COUNT; _i < textElements.length; _i++) {
          textElements[_i].hidden = true;
        }
        aboutContainerElement.classList.add('is-hide');
  ...
  _createClass(ScrollLock, [{
    ...
    value: function disableScrolling() {
      ...
      if (this._getScrollbarWidth()) {
        ...
        document.querySelector('.page-header__wrap').style.width = "".concat(window.innerWidth - this._getScrollbarWidth(), "px");
